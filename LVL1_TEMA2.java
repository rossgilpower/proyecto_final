...
public class LVL1_TEMA2 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"What's up?","Goodbye","Hello"};
	private String [] respuestas2 = {"Have a nice day!","Greetings!","Hey"};
	private String [] respuestas3 = {"Goodnight!","Good afternoon","See you later"};
	public LVL1_TEMA2(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);

		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl1_tema2_pregunta"+(j+1)+".jpg";
		}
