...
public class LVL1_TEMA3 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"Uno, dos, tres","Cuatro, cinco, seis","Siete, ocho, nueve"};
	private String [] respuestas2 = {"Doce, veinte, catorce","Uno, dos, diez","Cuatro, cinco, seis"};
	private String [] respuestas3 = {"Two hundred!","One hundred","One million"};
	
	public LVL1_TEMA3(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);
		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl1_tema3_pregunta"+(j+1)+".jpg";
		}
	...
	// Dibujar background
		...
		case 0: //pregunta 1
			...
			g.drawString("Amistad con Charlie:"+String.valueOf(amistad_charlie), 240,280);
			break;
		case 1: //pregunta 2
			g.setFont(font);	
