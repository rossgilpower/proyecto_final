...
// En esta clase se hacen las 5 preguntas

public class LVL1_TEMA1 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"Hello","Goodbye","Bye"};
	private String [] respuestas2 = {"Hi","Goodnight!","Welcome"};
	private String [] respuestas3 = {"Hey","Good Morning!","See you later"};
	
	public LVL1_TEMA1(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);

			lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
			try {
			for(int j = 0; j<questions.length;j++) {
				questions[j] = "/bg/lvl1_tema1_pregunta"+(j+1)+".jpg";
			}
