...
public class Lvl3 extends GameState {

	private Background bg;
	Font font = new Font("Verdana",Font.BOLD,20);
	private int selection = 0;
	BufferedImage lapiz;
	private String [] temas = {"Verbos regulares","Verbos irregulares","Preguntas","Volver"};
	
	public Lvl3(GameStateManager gsm) {
		super(gsm);
		try {
	...
	private void select() {
		switch(selection) {
		case 0:
			gsm.setState(GameStateManager.LVL3_TEMA1);
			break;
		case 1:
			gsm.setState(GameStateManager.LVL3_TEMA2);
			break;
		case 2:
			gsm.setState(GameStateManager.LVL3_TEMA3);
			break;
		case 3:
