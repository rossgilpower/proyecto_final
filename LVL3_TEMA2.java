...
public class LVL3_TEMA2 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"I bought","You bought","We bought"};
	private String [] respuestas2 = {"Dance","Fight","Paint"};
	private String [] respuestas3 = {"They ate and painted","You ran and bought it","I ran and danced"};
	
	public LVL3_TEMA2(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);
		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl3_tema2_pregunta"+(j+1)+".jpg";
		}
