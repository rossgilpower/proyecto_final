...
public class LVL3_TEMA3 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"When","Where","What"};
	private String [] respuestas2 = {"Where","How","Who"};
	private String [] respuestas3 = {"Who are you?","What are you?","Where are you?"};
	
	public LVL3_TEMA3(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);
		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl3_tema3_pregunta"+(j+1)+".jpg";
		}
