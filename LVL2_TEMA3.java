...
public class LVL2_TEMA3 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"January","February","March"};
	private String [] respuestas2 = {"Agosto","Septiembre","Octubre"};
	private String [] respuestas3 = {"Abril y mayo","Noviembre y diciembre","Junio y julio"};
	
	public LVL2_TEMA3(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);
		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl2_tema3_pregunta"+(j+1)+".jpg";
		}
