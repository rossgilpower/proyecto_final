...
public class LVL2_TEMA1 extends GameState{
	...
	BufferedImage lapiz;
	private String [] respuestas1 = {"She","He","It"};
	private String [] respuestas2 = {"We","They","You"};
	private String [] respuestas3 = {"I","We","You"};
	
	public LVL2_TEMA1(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);
		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl2_tema1_pregunta"+(j+1)+".jpg";
		}
