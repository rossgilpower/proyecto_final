...
public class LVL2_TEMA2 extends GameState{
	...
	public static int amistad_anna = 0;
	public static int cont_preguntas = 0;
	BufferedImage lapiz;
	private String [] respuestas1 = {"Monday","Tuesday","Wednesday"};
	private String [] respuestas2 = {"Thursday","Saturday","Sunday"};
	private String [] respuestas3 = {"Monday, Thursday and Friday","Monday, Tuesday and Wednesday","Monday, Tuesday and Friday"};
	
	public LVL2_TEMA2(GameStateManager gsm) throws FileNotFoundException, IOException {
		super(gsm);
		lapiz = ImageIO.read(new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\Proyecto_Final\\src\\bg\\lapicito.png"));
		try {
		for(int j = 0; j<questions.length;j++) {
			questions[j] = "/bg/lvl2_tema2_pregunta"+(j+1)+".jpg";
		}
	...
	// Dibujar background
		...
		case 0: //pregunta 1
			...
			g.drawString("Amistad con Anna:"+String.valueOf(amistad_anna), 240,280);
			break;
		case 1: //pregunta 2
			g.setFont(font);	
